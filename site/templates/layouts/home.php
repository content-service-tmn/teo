...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Fira+Sans:400,600,700,800" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="../assets/uikit/css/components/slider.min.css">

    <script type="text/javascript" src="../assets/js/jquery.min.js"></script>
    <script type="text/javascript" src="../assets/uikit/js/uikit.min.js"></script>
    <script type="text/javascript" src="../assets/uikit/js/components/slider.min.js"></script>
</head>
<body>
    ...
    <div class="container container_center">
        ...
        <div class="header__flex">
            ...
            <div class="header__logo">
                <a href="#" class="header__link"><img src="../assets/img/logo.png"></a>
            </div>
        ...
        <div class="structure__wrap structure__wrap_padding">
            <div class="structure__column">
                <div class="item item_medium item_info">
                    <div class="item__wrap">
                        <h4 class="item__heading_small">Здесь будет слоган</h4>
                    </div>
                </div>
            </div>
            <div class="structure__column">
