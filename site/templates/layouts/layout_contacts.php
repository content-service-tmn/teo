  ...
  <div class="Contacts__wrapper">
    ...
    <div class="Contacts__wrapper__block">
      <div class="Contacts__wrapper__block__title">
        <div class="Contacts__wrapper__block__title__sizes canSpeak">
      ...
      <div class="Contacts__wrapper__block__table">
        ...
        <div class="Contacts__wrapper__block__table__row">
          <div class="Contacts__wrapper__block__table__column canSpeak"><?=$item->text_page_title?></div>
          	...
          	<span data-qa-file="Contacts">
                ...
                <span class="Contacts__link Contacts__link__black">
                  <a class="Contacts__link__additional" rel="noopener noreferrer " target="_blank">
                    <span class="Contacts__link__text canSpeak"><?=$value->text_page_title?></span>
                  </a>
                </span>
                </div>
                <?php endforeach; ?>
