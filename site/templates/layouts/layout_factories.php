        ...
        <?php foreach ($page->children as $child): ?>
          ...
          <div class="factories__cell">
            <div class="factories__panel">
              <h3 class="factories__subheading"><?=$child->text_page_title?></h3>
              <p class="factories__text"><?=$child->text_page_description?></p>
              <a href="<?=$child->url?>" class="factories__link">перейти на страницу завода</a>
            </div>
          </div>
        <?php endforeach; ?>
    </div>
