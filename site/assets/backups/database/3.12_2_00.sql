# --- WireDatabaseBackup {"time":"2018-12-03 01:59:23","user":"admin","dbName":"teo","description":"","tables":[],"excludeTables":[],"excludeCreateTables":[],"excludeExportTables":[]}
...
INSERT INTO `session_login_throttle` (`name`, `attempts`, `last_attempt`) VALUES('admin', '1', '1543692407');
...
INSERT INTO `templates` (`id`, `name`, `fieldgroups_id`, `flags`, `cache_time`, `data`) VALUES('85', 'layout_callback-full', '139', '0', '0', '{\"slashUrls\":1,\"compile\":3,\"modified\":1543692644,\"ns\":\"\\\\\"}');

# --- /WireDatabaseBackup {"numTables":118,"numCreateTables":118,"numInserts":1958,"numSeconds":1}