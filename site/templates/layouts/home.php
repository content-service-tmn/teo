    ...
    <div class="header__wrapper">
      <div class="header__map-wrapper">
        ...
        <div class="header__svg header__svg_first">
          <svg id="svg1" class="" version="1.1" id="Слой_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          ...
          517.6,561 521,566.1 518.9,571.2 509.1,579.6 482.9,588.5 "/>
          ...
          254.4,388.4 262.4,369.8 244.2,359.4 209.1,363 202.8,357.3 188,357.3 170.1,348.6 148.6,362.8 149.1,372.4 "/>
          ...
          661.4,394.8 677.6,385.7 690.4,390.3 690.6,381.3 708.6,370.6 731,370.7 "/>
          </svg>
        </div>
        <div class="header__svg header__svg_second">
          <svg id="svg2" class="" version="1.1" id="Слой_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          viewBox="0 0 1119.1 660.8" style="enable-background:new 0 0 1119.1 660.8;" xml:space="preserve">
          <style type="text/css">
        ...
        <div class="header__content content">
          <h1 class="content__heading">Тюменское э231231кологическое объединение</h1>
          <p class="content__text"><?= $page->home_description_under_title ?></p>
        </div>
        <div class="header__content content">
          <h1 class="content__heading">Тюменское экологическое объе413423413динение</h1>
          <p class="content__text"><?= $page->home_description_under_title ?></p>
        </div>
      </div>
    </div>
