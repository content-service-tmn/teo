  ...
  <div class="menu">
        ...
        <div class="menu__cell">
          <div class="menu__nav nav">
            <a href="tel:<?= phoneLink($pages->get("template=layout_contacts")->site_phone) ?>"
               class="nav__phone"><?= $pages->get("template=layout_contacts")->site_phone ?></a>
            <ul class="nav__items">
    ...
    <div class="container container_center">
        ...
        <img src="<?= $config->urls->templates . 'assets/img/map.png' ?>" alt="" class="header__map">
            ...
            <h3 class="header__name header__name_ish">Ишим</h3></div>
...
<section class="support">
    <div class="container container_center">
        ...
        <div class="uk-slidenav-positionsupport__grid"data-uk-slider="{center:true}">
            ...
            <li class="uk-width-1-3">
                <div class="support__image"
                     ...
                     <ahref="" class="support__nav support__nav_left" data-uk-slider-item="previous"></a>
